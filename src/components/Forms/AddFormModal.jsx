...
const AddFormModal = ({ isOpen, onClose, onAddNewInitiative }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://5.181.217.153:5000/forms/initiatives", formData, {
                headers: {
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-96 max-w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        {icon && (
                            <div className="mt-2">
                                <img src={icon} alt="Icon preview" className="w-20 h-20 object-contain rounded-md" />
                            </div>
                        )}
                    </div>
