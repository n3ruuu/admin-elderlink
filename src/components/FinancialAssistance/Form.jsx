    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                ) : formValues.benefitType !== "No Benefit" ? (
                    <div>
                        <label className="block text-lg font-medium text-gray-700 mb-1">
            ...
            <div className="flex justify-between items-center mt-8">
                {/* Add Record Button */}
                <button
                    onClick={() => console.log("Add Record clicked")} // Replace with your handler
                    className="border w-[150px] h-[45px] border-[#219EBC] bg-transparent hover:bg-[#219EBC] hover:text-white text-[#219EBC] font-bold py-2 px-4 rounded transition-colors duration-300"
                >
                    Add Record
                </button>
