...
const Table = ({ membersData, onEdit, fetchMembersData, logAction }) => {
    ...
    const generatePDF = () => {
        ...
        doc.setFontSize(18)
        doc.setFont("helvetica", "bold")
        doc.text("Members List", doc.internal.pageSize.width / 2, 30, { align: "center" })
        ...
        doc.autoTable({
            ...
            headStyles: {
                ...
                lineWidth: 0.1, // Reduced border thickness for header cells
                lineColor: [0, 0, 0], // Black border for header cells
            }, // Header styling
            bodyStyles: {
                fontSize: 10, // Body text size
                textColor: [0, 0, 0], // Black text color
                lineWidth: 0.1, // Reduced border thickness for body cells
        ...
        // Save the PDF
        doc.save("members_list_report.pdf")
    }
