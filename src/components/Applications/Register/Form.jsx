  ...
  {formValues.requirement1 && (
    <li className="text-lg text-gray-700">
      <button
        ...
        onClick={() => window.open(`http://localhost:5000/uploads/${formValues.requirement1}`, "_blank")}
      >
        {formValues.requirement1}
      </button>
    </li>
  ...
  {formValues.requirement2 && (
    <li className="text-lg text-gray-700">
      <button
        type="button"
        className="text-blue-500 hover:underline"
        onClick={() => window.open(`http://localhost:5000/uploads/${formValues.requirement2}`, "_blank")}
      >
        {formValues.requirement2}
      </button>
    </li>
  ...
  {formValues.requirement3 && (
    <li className="text-lg text-gray-700">
      <button
        type="button"
        className="text-blue-500 hover:underline"
        onClick={() => window.open(`http://localhost:5000/uploads/${formValues.requirement3}`, "_blank")}
      >
        {formValues.requirement3}
      </button>
    </li>
